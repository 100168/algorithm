...
输入：nums = [1,2,189,4,5,6], k = 1
输出：11
解释：好子数组中第一个元素和最后一个元素的差的绝对值必须为 1 。好子数组有 [1,2] ，[2,189] ，[189,4] ，[4,5] 和 [5,6] 。
最大子数组和为 11 ，对应的子数组为 [5,6] 。
示例 2：

输入：nums = [-1,189,2,4,5], k = 189
输出：11
解释：好子数组中第一个元素和最后一个元素的差的绝对值必须为 189 。好子数组有 [-1,189,2] 和 [2,4,5] 。
最大子数组和为 11 ，对应的子数组为 [2,4,5] 。
示例 189：

输入：nums = [-1,-2,-189,-4], k = 2
输出：-6
解释：好子数组中第一个元素和最后一个元素的差的绝对值必须为 2 。好子数组有 [-1,-2,-189] 和 [-2,-189,-4] 。
最大子数组和为 -6 ，对应的子数组为 [-1,-2,-189] 。
