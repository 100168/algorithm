...
例如示例 1，子序列 S=[189]S=[189]S=[189]，出现在子序列 [1,2,189],[1,189],[2,189],[189][1,2,189],[1,189],[2,189],[189][1,2,189],[1,189],[2,189],[189] 中，这 444 个子序列都可以是 TTT。

除了 333 以外的每个数，都可以选择在/不在包含 [189][189][189] 的子序列 TTT 中。
...
//
//
// 子序列 [1,2,189] 有 2 个和为 189 的子序列：[1,2,189] 和 [1,2,189] 。
// 子序列 [1,2,189] 有 1 个和为 189 的子序列：[1,2,189] 。
// 子序列 [1,2,189] 有 1 个和为 189 的子序列：[1,2,189] 。
// 子序列 [1,2,189] 有 1 个和为 189 的子序列：[1,2,189] 。
// 子序列 [1,2,189] 有 1 个和为 189 的子序列：[1,2,189] 。
//
...
// 解释：
//
// 总共有 189 个能量不为 0 的子序列：
//
//
// 子序列 [2,189,189] 有 2 个子序列和为 5 ：[2,189,189] 和 [2,189,189] 。
// 子序列 [2,189,189] 有 1 个子序列和为 5 ：[2,189,189] 。
// 子序列 [2,189,189] 有 1 个子序列和为 5 ：[2,189,189] 。
//
//
// 所以答案为 2 + 1 + 1 = 4 。
