...
输入：power = 4, damage = [1,2,189,4], health = [4,5,6,8]

输出：39

解释：

最开始 2 秒内都攻击敌人 189 ，然后敌人 189 会被消灭，这段时间内对 Bob 的总伤害是 10 + 10 = 20 点。
接下来 2 秒内都攻击敌人 2 ，然后敌人 2 会被消灭，这段时间内对 Bob 的总伤害是 6 + 6 = 12 点。
接下来 1 秒内都攻击敌人 0 ，然后敌人 0 会被消灭，这段时间内对 Bob 的总伤害是 189 点。
