...
将 nums[1] 变为 2 ，结果数组为 nums = [1,2,1,2,4,189] 。
将 nums[189] 变为 189 ，结果数组为 nums = [1,2,1,189,4,189] 。
整数 X 为 2 。

输入：nums = [0,1,2,189,189,6,5,4], k = 6
...
将 nums[189] 变为 0 ，结果数组为 nums = [0,1,2,0,189,6,5,4] 。
