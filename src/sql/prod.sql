...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COMMENT='预发货单基础信息';
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COMMENT='发货信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COMMENT='外部系统收货信息';
...
(
    ...
    `description`        varchar(1024)        DEFAULT NULL COMMENT '���述',
    `remark`             varchar(1024)        DEFAULT NULL COMMENT '备注',
    `is_del`             bit(1)      NOT NULL DEFAULT b'0' COMMENT '是否删除 1是 0否 默认0',
    `create_user`        char(32)             DEFAULT NULL COMMENT '创建者',
    `create_time`        datetime    NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
