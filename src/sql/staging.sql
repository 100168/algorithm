...
) ENGINE=InnoDB AUTO_INCREMENT=99 DEFAULT CHARSET=utf8mb4 COMMENT='预发货单基础信息';
...
) ENGINE=InnoDB AUTO_INCREMENT=113 DEFAULT CHARSET=utf8mb4 COMMENT='发货信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=48 DEFAULT CHARSET=utf8mb4 COMMENT='外部系统收货信息';
...
(
    ...
    `description`           varchar(1024)         DEFAULT NULL COMMENT '描述',
    PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='訂單日曆表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='要货计划';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='要货计划修改记录';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='托盘主数据';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='销售价格';
...
(
    ...
    `update_time`         datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
    PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='销售价格审批';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='销售价格审批附件';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='销售价格审批价格明细';