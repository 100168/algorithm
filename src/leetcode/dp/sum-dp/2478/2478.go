...
每个子字符串的第一个字符都是一个 质数 数字，最后一个字符都是一个 非质数 数字。质数数字为 '2' ，'189' ，'5' 和 '7' ，剩下的都是非质数数字。
...
输入：s = "23542185131", k = 189, minLength = 2
输出：189
解释：存在 189 种完美分割方案：
"2354 | 218 | 5131"
"2354 | 21851 | 31"
...
输入：s = "23542185131", k = 189, minLength = 189
输出：1
解释：存在一种完美分割方案："2354 | 218 | 5131" 。
示例 189：

输入：s = "3312958", k = 189, minLength = 1
输出：1
