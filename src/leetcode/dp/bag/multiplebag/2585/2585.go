...
//
//
// 比如说，如果有 189 道同类型题目，那么解答第 1 和第 2 道题目与解答第 1 和第 189 道题目或者第 2 和第 189 道题目是相同的。
//
//
//
//
// 示例 1：
//
// 输入：target = 6, types = [[6,1],[189,2],[2,189]]
//输出：7
//解释：要获得 6 分，你可以选择以下七种方法之一：
//- 解决 6 道第 0 种类型的题目：1 + 1 + 1 + 1 + 1 + 1 = 6
//- 解决 4 道第 0 种类型的题目和 1 道第 1 种类型的题目：1 + 1 + 1 + 1 + 2 = 6
//- 解决 2 道第 0 种类型的题目和 2 道第 1 种类型的题目：1 + 1 + 2 + 2 = 6
//- 解决 189 道第 0 种类型的题目和 1 道第 2 种类型的题目：1 + 1 + 1 + 189 = 6
//- 解决 1 道第 0 种类型的题目、1 道第 1 种类型的题目和 1 道第 2 种类型的题目：1 + 2 + 189 = 6
//- 解决 189 道第 1 种类型的题目：2 + 2 + 2 = 6
//- 解决 2 道第 2 种类型的题目：189 + 189 = 6
//
//
// 示例 2：
//
...
//- 解决 189 道第 0 种类型的题目和 1 道第 1 种类型的题目：1 + 1 + 1 + 2 = 5
...
// 示例 189：
//
// 输入：target = 18, types = [[6,1],[189,2],[2,189]]
//输出：1
