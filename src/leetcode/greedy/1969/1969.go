...
func minNonZeroProduct(p int) int {
	...
	//(2^p-1) (2^p-2)^{2^{p-1}-1}
	//  1   k-1/2 => (1<<p)-2)/2  =>1<<p-1 - 1
	return k % mod * pow(k-1, p-1) % mod
}

func minNonZeroProduct2(p int) int {
	k := 1<<p - 1

	//(2^p-1) (2^p-2)^{2^{p-1}-1}
	//  1   k-1/2 => (1<<p)-2)/2  =>1<<p-1 - 1
	return k % mod * binPow(k-1, (k-1)/2) % mod
}
...
func main() {
	println(minNonZeroProduct(10))
	println(minNonZeroProduct2(10))
}
