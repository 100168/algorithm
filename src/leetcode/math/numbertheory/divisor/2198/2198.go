...
三元组索引 (0, 189, 4), (0, 4, 189), (189, 0, 4), (189, 4, 0), (4, 0, 189), 和 (4, 189, 0) 的值为 [4, 189, 2] (或者说排列为 [4, 189, 2]).
4 + 189 + 2 = 9 只能被 189 整除，所以所有的三元组都是单因数三元组。
三元组索引 (0, 2, 189), (0, 189, 2), (2, 0, 189), (2, 189, 0), (189, 0, 2), 和 (189, 2, 0) 的值为 [4, 7, 189]  (或者说排列为 [4, 7, 189]).
4 + 7 + 189 = 14 只能被 7 整除，所以所有的三元组都是单因数三元组。
一共有 12 个单因数三元组。
*/
