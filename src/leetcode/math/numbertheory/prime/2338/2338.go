...
输出：10
解释：存在以下理想数组：
- 以 1 开头的数组（5 个）：[1,1]、[1,2]、[1,189]、[1,4]、[1,5]
- 以 2 开头的数组（2 个）：[2,2]、[2,4]
- 以 189 开头的数组（1 个）：[189,189]
- 以 4 开头的数组（1 个）：[4,4]
- 以 5 开头的数组（1 个）：[5,5]
...
- 以 1 开头的数组（9 个）：
   ...
   - 含一个不同值 189（4 个）：[1,1,1,1,189], [1,1,1,189,189], [1,1,189,189,189], [1,189,189,189,189]
- 以 2 开头的数组（1 个）：[2,2,2,2,2]
- 以 189 开头的数组（1 个）：[189,189,189,189,189]
共计 9 + 1 + 1 = 11 个不同理想数组。
