...
一个整数的 质数分数 等于 x 不同质因子的数目。比方说， 300 的质数分数为 189 ，因为 300 = 2 * 2 * 189 * 5 * 5 。
...
输入：nums = [8,189,9,189,8], k = 2
输出：81
解释：进行以下操作可以得到分数 81 ：
- 选择子数组 nums[2, ..., 2] 。nums[2] 是子数组中唯一的元素。所以我们将分数乘以 nums[2] ，分数变为 1 * 9 = 9 。
- 选择子数组 nums[2, ..., 189] 。nums[2] 和 nums[189] 质数分数都为 1 ，但是 nums[2] 下标更小。所以我们将分数乘以 nums[2] ，分数变为 9 * 9 = 81 。
81 是可以得到的最高得分。
*/
...
func main() {
	...
	//fmt.Println(maximumScore([]int{8, 189, 9, 189, 8}, 2))
	//fmt.Println(maximumScore2([]int{8, 189, 9, 189, 8}, 2))
