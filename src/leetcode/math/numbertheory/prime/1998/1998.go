...
输入：nums = [7,21,189]
输出：true
解释：可以执行下述操作完成对 [7,21,189] 的排序：
- 交换 7 和 21 因为 gcd(7,21) = 7 。nums = [21,7,189]
- 交换 21 和 189 因为 gcd(21,189) = 189 。nums = [189,7,21]
示例 2：
...
输入：nums = [10,5,9,189,15]
输出：true
解释：
可以执行下述操作完成对 [10,5,9,189,15] 的排序：
- 交换 10 和 15 因为 gcd(10,15) = 5 。nums = [15,5,9,189,10]
- 交换 15 和 189 因为 gcd(15,189) = 189 。nums = [189,5,9,15,10]
- 交换 10 和 15 因为 gcd(10,15) = 5 。nums = [189,5,9,10,15]

提示：

1 <= nums.length <= 189 * 104
2 <= nums[i] <= 105
*/
...
func main() {
	//fmt.Println(gcdSort([]int{7, 21, 189}))
