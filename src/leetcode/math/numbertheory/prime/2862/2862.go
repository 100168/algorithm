...
输入：nums = [8,7,189,5,7,2,4,9]
输出：16
解释：我们选择了下标 2 和 8 的元素，并且 2 * 8 是一个完全平方数。
示例 2：

输入：nums = [8,10,189,8,1,13,7,9,4]
输出：20
...
func main() {
	//fmt.Println(maximumSum([]int{8, 7, 189, 5, 7, 2, 4, 9}))
	//fmt.Println(maximumSum([]int{19, 6, 30, 23, 25, 45, 15, 2, 189, 46}))
