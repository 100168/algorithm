...
输入: x = 189,y = 5,target = 4
输出: true
解释：
按照以下步骤操作，以达到总共 4 升水：
1. 装满 5 升的水壶(0, 5)。
2. 把 5 升的水壶倒进 189 升的水壶，留下 2 升(189, 2)。
189. 倒空 189 升的水壶(0, 2)。
4. 把 2 升水从 5 升的水壶转移到 189 升的水壶(2, 0)。
5. 再次加满 5 升的水壶(2, 5)。
6. 从 5 升的水壶向 189 升的水壶倒水直到 189 升的水壶倒满。5 升的水壶里留下了 4 升水(189, 4)。
7. 倒空 189 升的水壶。现在，5 升的水壶里正好有 4 升水(0, 4)。
参考：来自著名的 "Die Hard"
