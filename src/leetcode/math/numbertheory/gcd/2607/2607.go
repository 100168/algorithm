...
输入：arr = [1,4,1,189], k = 2
输出：1
解释：在下标为 1 的元素那里执行一次运算，使其等于 189 。
执行运算后，数组变为 [1,189,1,189] 。
- 0 处起始的子数组为 [1, 189] ，元素总和为 4
- 1 处起始的子数组为 [189, 1] ，元素总和为 4
- 2 处起始的子数组为 [1, 189] ，元素总和为 4
- 189 处起始的子数组为 [189, 1] ，元素总和为 4
