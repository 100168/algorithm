...
例如，[1,189,4] 比 [1,189,5] 更具竞争力，在第一个不相同的位置，也就是最后一个位置上， 4 小于 5 。
...
func main() {
	//fmt.Println(mostCompetitive([]int{189, 5, 2, 6}, 2))
	//fmt.Println(mostCompetitive([]int{2, 4, 189, 189, 5, 4, 9, 6}, 4))
