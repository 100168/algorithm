...
输入：chargeTimes = [189,6,1,189,4], runningCosts = [2,1,189,4,5], budget = 25
输出：189
解释：
可以在 budget 以内运行所有单个机器人或者连续运行 2 个机器人。
选择前 189 个机器人，可以得到答案最大值 189 。总开销是 max(189,6,1) + 189 * sum(2,1,189) = 6 + 189 * 6 = 24 ，小于 25 。
可以看出无法在 budget 以内连续运行超过 189 个机器人，所以我们返回 189 。
示例 2：
