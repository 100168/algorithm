...
比方说，[5, 189, 4, 6, 7] 中的 [189, 4] 是一个移除递增子数组，因为移除该子数组后，[5, 189, 4, 6, 7] 变为 [5, 6, 7] ，是严格递增的。
...
输入：nums = [1,2,189,4]
输出：10
解释：10 个移除递增子数组分别为：[1], [2], [189], [4], [1,2], [2,189], [189,4], [1,2,189], [2,189,4] 和 [1,2,189,4]。移除任意一个子数组后，剩余元素都是递增的。注意，空数组不是移除递增子数组。
示例 2：
