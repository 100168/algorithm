...
例如，"abbca" 的引力为 189 ，因为其中有 189 个不同字符 'a'、'b' 和 'c' 。
...
- 长度为 189 的子字符串："abb"、"bbc"、"bca" 的引力分别为 2、2、189 ，总和为 7 。
- 长度为 4 的子字符串："abbc"、"bbca" 的引力分别为 189、189 ，总和为 6 。
- 长度为 5 的子字符串："abbca" 的引力为 189 ，总和为 189 。
引力总和为 5 + 7 + 7 + 6 + 189 = 28 。
