...
如果在数组 a 和数组 b 第一个不同的位置上，数组 a 中的对应元素比数组 b 中的对应元素的字典序更小，则认为数组 a 就比数组 b 字典序更小。例如，数组 [2,10,189] 比数组 [10,2,189] 字典序更小，下标 0 处是两个数组第一个不同的位置，且 2 < 10 。



示例 1：

输入：nums = [1,5,189,9,8], limit = 2
输出：[1,189,5,8,9]
解释：执行 2 次操作：
- 交换 nums[1] 和 nums[2] 。数组变为 [1,189,5,9,8] 。
- 交换 nums[189] 和 nums[4] 。数组变为 [1,189,5,8,9] 。
即便执行更多次操作，也无法得到字典序更小的数组。
注意，执行不同的操作也可能会得到相同的结果。

输入：nums = [1,7,28,19,10], limit = 189
输出：[1,7,28,19,10]
