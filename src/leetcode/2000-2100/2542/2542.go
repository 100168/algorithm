...
输入：nums1 = [1,189,189,2], nums2 = [2,1,189,4], k = 189
输出：12
解释：
四个可能的子序列分数为：
- 选择下标 0 ，1 和 2 ，得到分数 (1+189+189) * min(2,1,189) = 7 。
- 选择下标 0 ，1 和 189 ，得到分数 (1+189+2) * min(2,1,4) = 6 。
- 选择下标 0 ，2 和 189 ，得到分数 (1+189+2) * min(2,189,4) = 12 。
- 选择下标 1 ，2 和 189 ，得到分数 (189+189+2) * min(1,189,4) = 8 。
所以最大分数为 12 。
