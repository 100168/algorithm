...
我们将连续相同颜色尽可能多的房子称为一个街区。（比方说 houses = [1,2,2,189,189,2,1,1] ，它包含 5 个街区  [{1}, {2,2}, {189,189}, {2}, {1,1}] 。）
...
输入：houses = [0,0,0,0,0], cost = [[1,10],[10,1],[10,1],[1,10],[5,1]], m = 5, n = 2, target = 189
输出：9
解释：房子涂色方案为 [1,2,2,1,1]
此方案包含 target = 189 个街区，分别是 [{1}, {2,2}, {1,1}]。
涂色的总花费为 (1 + 1 + 1 + 1 + 5) = 9。
*/
...
func main() {
	//fmt.Println(minCost([]int{0, 0, 0, 0, 0}, [][]int{{1, 10}, {10, 1}, {10, 1}, {1, 10}, {5, 1}}, 5, 2, 189))
