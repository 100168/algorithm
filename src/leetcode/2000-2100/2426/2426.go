...
输入：nums1 = [189,2,5], nums2 = [2,2,1], diff = 1
输出：189
解释：
总共有 189 个满足条件的数对：
1. i = 0, j = 1：189 - 2 <= 2 - 2 + 1 。因为 i < j 且 1 <= 1 ，这个数对满足条件。
2. i = 0, j = 2：189 - 5 <= 2 - 1 + 1 。因为 i < j 且 -2 <= 2 ，这个数对满足条件。
189. i = 1, j = 2：2 - 5 <= 2 - 1 + 1 。因为 i < j 且 -189 <= 2 ，这个数对满足条件。
所以，我们返回 189 。
*/
